...
from src.config import GROQ_MODEL, GROQ_API_KEY, TEMPARATURE, MAX_TOKENS, DB_PATH
...
if __name__ == "__main__":
    ...
    test_questions = [
        "All shoes with rating higher than 4.5 and total number of reviews greater than 500",
